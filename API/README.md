...
### Optional but highly encouraged fields
  ...
  *caloriesPerServing*: A non-negative number that describes the number of meal kilocalories.
  
  *nutrientsPerServing*: A JSON object describing the nutritional macro-composition of the meal. See the Nutrients object below.
