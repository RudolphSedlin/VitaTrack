...
const ChatGptTest: React.FC = () => {
    ...
    const getNutritionAnalysis = async (foodImage: string) => {
        const openaiApiKey =
            "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";
        setLoading(true);
        try {
                    ...
                    { role: "system", content: "You are a nutritionist." },
                    {
                        ...
                        content: [
                            { type: "text", text: prompt },
                            {
                                type: "image_url",
                                image_url: {
                                    url: `data:image/jpeg;base64,${foodImage}`,
                                },
                            },
                        ],
                    },
