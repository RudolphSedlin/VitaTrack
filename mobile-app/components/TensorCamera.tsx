// Used from tfjs-react-native
// Had to use raw file b/c the package is out of date and I needed to update it to be compatible
/**
 * @license
...
import { Rotation } from "./camera/types";
  ...
  > {
    ...
    previewUpdateFunc(
      ...
      const renderFunc = () => {
        ...
        const isFrontCamera = this.camera.facing === "front";
    ...
    override render() {
      ...
      const cameraComp = (
        ...
        <CameraComponent
          ...
          {...cameraProps}
          ref={(ref: CameraView) => (this.camera = ref)}
        />
      );
