            ...
            <View style={styles.columns}>
                ...
                <View>
                    <View style={styles.columns}>
                        ...
                        <Text style={colorScheme == "dark" ? styles.lightLegendText : styles.darkLegendText}>FATS: </Text>
                    ...
                    <View style={styles.columns}>
                        ...
                        <Text style={colorScheme == "dark" ? styles.lightLegendText : styles.darkLegendText}>CARBS: </Text>
                    ...
                    <View style={styles.columns}>
                        ...
                        <Text style={colorScheme == "dark" ? styles.lightLegendText : styles.darkLegendText}>PROTIENS: </Text>
                    ...
                    <View style={styles.columns}>
                        ...
                        <Text style={colorScheme == "dark" ? styles.lightLegendText : styles.darkLegendText}>SUGARS: </Text>
